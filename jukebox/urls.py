...
urlpatterns = [
    ...
    url(r'^folder/(?P<folder_id>[0-9]*)/move/(?P<old_position>[0-9]*),(?P<new_position>[0-9]*)$', views.move_folder, name='move_folder'),
    ...
    url(r'^set_queue$', views.set_queue, name='set_queue'),
